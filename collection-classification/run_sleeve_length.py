...
from app.models.sleeve_length import (SleeveLengthModelContainer,
                                      SleeveLengthModelContainerAtResNet)
from app.models.manager import ModelStore
from app.prediction.processor import ClassificationProcessor
from app.services.sleeve_length import SleeveLengthClassificationService
...
def get_service(model_store: ModelStore, dataset_store: DatasetStore):
    return SleeveLengthClassificationService(model_store, dataset_store)
...
def command_learn(train_dataset_key: str=None,
    ...
    model_container = SleeveLengthModelContainerAtResNet(class_num)
...
def command_predict(model_key: str=None, org_dataset_path: str=None,
    ...
    service = SleeveLengthClassificationService(model_store, dataset_store)

    label = ['normal', 'tight', 'wide']
