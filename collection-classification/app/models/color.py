...
class ColorModelContainer(ModelContainer):
...
class ColorModelContainerOn3Layer(ColorModelContainer):
    ...
    def get_feature_model(self, input_shape):
        ...
        x = Convolution2D(64, 3, 3, activation='relu',
                          name='conv1_1', trainable=conv_trainable)(x)
        x = BatchNormalization()(x)
        x = ZeroPadding2D((1, 1))(x)
        x = Convolution2D(64, 3, 3, activation='relu',
                          name='conv1_2', trainable=conv_trainable)(x)
        x = BatchNormalization()(x)
        x = MaxPooling2D((2, 2), strides=(2, 2))(x)

        x = ZeroPadding2D((1, 1))(x)
        x = Convolution2D(128, 3, 3, activation='relu',
                          name='conv2_1', trainable=conv_trainable)(x)
        x = BatchNormalization()(x)
        x = ZeroPadding2D((1, 1))(x)
        x = Convolution2D(128, 3, 3, activation='relu',
                          name='conv2_2', trainable=conv_trainable)(x)
        x = BatchNormalization()(x)
        x = MaxPooling2D((2, 2), strides=(2, 2))(x)

        x = ZeroPadding2D((1, 1))(x)
        x = Convolution2D(256, 3, 3, activation='relu',
                          name='conv3_1', trainable=conv_trainable)(x)
        x = BatchNormalization()(x)
        x = ZeroPadding2D((1, 1))(x)
        x = Convolution2D(256, 3, 3, activation='relu',
                          name='conv3_2', trainable=conv_trainable)(x)
        x = BatchNormalization()(x)
        x = ZeroPadding2D((1, 1))(x)
        x = Convolution2D(256, 3, 3, activation='relu',
                          name='conv3_3', trainable=conv_trainable)(x)
        x = BatchNormalization()(x)
        x = MaxPooling2D((2, 2), strides=(2, 2))(x)

        # update vgg16 model layer count
        self.feature_layer_count = 18
...
class ColorModelContainerOn2Layer(ColorModelContainer):
...
class ColorModelContainerOn1Layer(ColorModelContainer):
...
class ColorModelContainerAtResNet(ColorModelContainer):
    ...
    def get_feature_model(self, input_shape):
        ...
        return ResnetBuilder.build_resnet_18(input_shape, self._classes)
