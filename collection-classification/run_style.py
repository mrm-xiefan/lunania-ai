...
from app.models.style import (StyleModelContainer,
                              StyleModelContainerAtResNet)
from app.models.manager import ModelStore
from app.prediction.processor import ClassificationProcessor
from app.services.style import StyleClassificationService
...
def get_service(model_store: ModelStore, dataset_store: DatasetStore):
    return StyleClassificationService(model_store, dataset_store)
...
def command_learn(train_dataset_key: str=None,
    ...
    model_container = StyleModelContainerAtResNet(class_num)
...
def command_predict(model_key: str=None, org_dataset_path: str=None,
    ...
    service = StyleClassificationService(model_store, dataset_store)
    ...
    csv_name = 'style-predict' + dt.now().strftime('-%Y%m%d%H%M%S') + '.csv'
